...
"x86_64-linux-thread-multi-5.8.0-1042-azure" or
	die "Errno architecture (x86_64-linux-thread-multi-5.8.0-1042-azure) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
